...
json_path = f"{workspace_base_path}/temp_json"
spark.table(ORDERS).limit(50000).write.mode("overwrite").json(json_path)
...
print(f"Filtered DataFrame partitions: {filtered.rdd.getNumPartitions()}")
